...
class _AppApiService implements AppApiService {
  ...
  @override
  Future<HttpResponse<MoviesResponse>> searchMovies(String searchText) async {
  ...
  @override
  Future<HttpResponse<DetailMovieResponse>> getMovieById(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<DetailMovieResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
